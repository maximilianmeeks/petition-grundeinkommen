    ...
    query {
      ...
      return (
        <div className="img-gallery">
          ...
          <Row>
            <Col xs={6}>
              <div className="hover-zoom" onClick={() => clickHandler(true, data.facebook01)}>
                <Img fluid={data.facebook01.childImageSharp.fluid} alt="Thumbnail" className="img-thumbnail"/>
              </div>
            </Col>
            <Col xs={6}>
              <div className="hover-zoom" onClick={() => clickHandler(true, data.facebook02)}>
          ...
          <Row>
            <Col xs={6}>
              <div className="hover-zoom" onClick={() => clickHandler(true, data.facebook03)}>
                <Img fluid={data.facebook03.childImageSharp.fluid} alt="Thumbnail" className="img-thumbnail"/>
              </div>
            </Col>
            <Col xs={6}>
              <div className="hover-zoom" onClick={() => clickHandler(true, data.facebook04)}>
          ...
          <Row>
            <Col xs={6}>
              <div className="hover-zoom" onClick={() => clickHandler(true, data.facebook05)}>
                <Img fluid={data.facebook05.childImageSharp.fluid} alt="Thumbnail" className="img-thumbnail"/>
              </div>
            </Col>
            <Col xs={6}>
              <div className="hover-zoom" onClick={() => clickHandler(true, data.facebook06)}>
          ...
          <Row>
            <Col xs={6}>
              <div className="hover-zoom" onClick={() => clickHandler(true, data.facebook07)}>
                <Img fluid={data.facebook07.childImageSharp.fluid} alt="Thumbnail" className="img-thumbnail"/>
              </div>
            </Col>
            <Col xs={6}>
              <div className="hover-zoom" onClick={() => clickHandler(true, data.facebook08)}>
                <Img fluid={data.facebook08.childImageSharp.fluid} alt="Thumbnail" className="img-thumbnail"/>
              </div>
            </Col>
            <Col xs={6}>
              <div className="hover-zoom" onClick={() => clickHandler(true, data.facebook09)}>
