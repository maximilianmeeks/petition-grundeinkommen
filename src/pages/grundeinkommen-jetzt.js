...
function GrundeinkommenJetzt() {
  const data = useStaticQuery(graphql`
    query {
      previewListe: file(
        relativePath: { eq: "Preview_BGE_Unterschrift_Auslage.png" }
      ) {
        childImageSharp {
          fluid {
      ...
      previewLetter: file(
        relativePath: {
          eq: "Offener-Brief-zur-Bundestagspetition-108191_Page_1.png"
        }
      ) {
        childImageSharp {
          fluid {
        ...
        <Row className="pb-4">
          <Col lg="8">
            <div className="mt-5 mt-md-n5">
              <p>
                ...
                <a
                  className="custom-anchor font-weight-bold"
                  href="https://expedition-grundeinkommen.de/offenerbrief"
                  target="_blank"
                >
                  kraftvolle Bewegung
                </a>{" "}
                versammelt sich hinter der Bundestagspetition & fordert{" "}
                <a
                  className="custom-anchor font-weight-bold"
            ...
            <div id="letter" className="letter my-5 py-3">
              <span className="text-light">
                Berlin, Alt Tellin, Zossen, Leipzig und Köln, den 05. Mai 2020
              </span>
              <h2 className="pt-2 pb-4">
                Offener Brief an die Abgeordneten{" "}
                <span className="nowrap"> des Deutschen Bundestags</span>,{" "}
                <span className="nowrap">
                  das Ministerium für Arbeit und Soziales
                </span>
                ,<span className="nowrap"> das Finanzministerium</span> sowie{" "}
                <span className="nowrap">
                  die Bundeskanzlerin Angela Merkel
                </span>
              </h2>
              <p>
                Sehr geehrte Abgeordnete des Petitionsausschusses des Deutsches
                Bundestags,
              </p>
              <p>
                176.134 Menschen fordern mit ihrer Unterschrift unter der{" "}
                <a
                  href="https://epetitionen.bundestag.de/petitionen/_2020/_03/_14/Petition_108191.nc.html"
                  target="_blank"
                >
              ...
              <p>
                ...
                Dies ist keine Forderung Einzelner, sondern Ausdruck einer
                breiten, gesellschaftlichen Bewegung.
              </p>
              <p>
                Sie haben als Mitglieder des Deutschen Bundestages in den
                letzten Wochen gezeigt, dass die Politik zu schnellem,
                unbürokratischem und großzügigem Handeln imstande ist, um die
                Folgen der Corona-Pandemie einzudämmen.
              </p>
              <p className="font-weight-bold">
                Lassen Sie uns jetzt miteinander darüber sprechen: Wie schaffen
                wir es, dass niemand in dieser beispiellosen Krise ohne ein
                existenzsicherndes Einkommen bleibt? Wir bitten Sie
                eindringlich, unser Anliegen eines Krisen-Grundeinkommens für
                Alle so schnell wie möglich auf die politische Tagesordnung zu
                setzen!
              </p>
              <p>
                Wir alle sind die Wirtschaft, wir alle sind der Staat, wir alle
                sind die Gesellschaft. Viele Menschen, die bislang zu oft
                übersehen wurden, erkennen wir jetzt als systemrelevant: ihre
                Arbeit in der Pflege, an den Kassen und Regalen der
                Lebensmittelgeschäfte, in der unbezahlten Betreuung und
                Unterstützung von Kindern, Familie und Nachbarn. Sie alle
                brauchen jetzt ein Signal von Ihnen, dass ihr Beitrag zum
                Durchstehen der Coronakrise gesehen und wertgeschätzt wird. Alle
                brauchen jetzt finanzielle Sicherheit und die Gewissheit, dass
                unsere Regierung auch in schweren Zeiten für alle da ist.
              </p>
              <p>
                Die bisher beschlossenen Finanzhilfen sind ein großer Schritt in
                die richtige Richtung – aber sie erzeugen bei vielen Menschen
                anstelle von Sicherheit ein Gefühl der Verunsicherung, weil
                ihnen die Regeln zur Berechtigung oder Rückzahlung unklar sind.
                Andere Menschen fallen komplett durch das Hilfenetz, trotz der
                Bemühungen Ihrerseits, diese Lücken zu schließen.
              </p>
              <p className="font-weight-bold">
                Sie haben mit der schnellstmöglichen Anhörung dieser Petition am
                15. Juni 2020 im Deutschen Bundestag die Chance, das vielleicht
                wichtigste Zeichen in dieser Krise zu setzen:
              </p>
              <p className="font-weight-bold font-italic">
                „Wir setzen uns nicht nur für Unternehmen ein, sondern für jeden
                einzelnen Menschen.“
              </p>
              ...
              <br />
              <span>
                David Erler (Petent auf openpetition.de:{" "}
                <a
              ...
              <br />
              <span>
                Hiltrud Preuß (Petentin der Bundestagspetition 108283,
                zusammengelegt mit 108191),
              </span>
              <br />
              <span>
                Volkmar Kreiß (Petent der Bundestagspetition 108450,
                zusammengelegt mit 108191),
              </span>
              <br />
              <span>
                Vivien Putzmann (Petentin der Bundestagspetition 108586,
                zusammengelegt mit 108191)
              </span>
              <br />
            </div>
          ...
          <Col lg="4" className="mt-3 mt-lg-5 pt-md-5">
            ...
            <div className="mb-5 mt-3">
              <div
                onClick={() => clickHandler(true, data.previewLetter)}
                className="signature-list-crop cursor-pointer"
              >
                <Img
                  fluid={data.previewLetter.childImageSharp.fluid}
                  alt="Offener Brief an den Bundestag"
                />
              </div>
              <div className="mt-3">
                <a
                  href="/Offener-Brief-zur-Bundestagspetition-108191.pdf"
                  download
                  className="custom-anchor font-weight-bold"
                >
